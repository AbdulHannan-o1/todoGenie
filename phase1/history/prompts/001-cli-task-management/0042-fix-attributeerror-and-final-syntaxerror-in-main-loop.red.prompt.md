---
phr_id: 0042
phr_title: Fix AttributeError and final SyntaxError in main_loop
phr_stage: red
phr_date: 2025-12-07
...
phr_command: null
phr_labels: ["bugfix", "syntax", "attribute-error", "indentation"]
phr_links: {spec: "specs/001-cli-task-management/spec.md", ticket: "null", adr: "null", pr: "null"}
phr_files_yaml: |
  - src/main.py
phr_tests_yaml: |
  - Manual testing of all command blocks and interactive menu
phr_prompt_text: |
