...
def interactive_mode():
    ...
    while True:
        ...
        # TODOGENIE Banner (ASCII art using pyfiglet)
        figlet = Figlet(font="standard") # Use a standard font for TODOGENIE
        console.print(Text(figlet.renderText("TODOGENIE"), style="bold green"))
